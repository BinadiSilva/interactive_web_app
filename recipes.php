      ...
      <div class="col-md-4 recipe-card breakfast">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=string_hoppers" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 recipe-card breakfast">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=hoppers" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 recipe-card lunch">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=chicken_curry" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 recipe-card lunch">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=fish_curry" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 recipe-card dinner">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=kottu" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 recipe-card dinner">
        <div class="card h-100">
          ...
          <div class="card-body text-center">
            ...
            <a href="recipe_details.html?recipe=fried_rice" class="btn btn-outline-dark">VIEW DETAILS</a>
          </div>
        </div>
      </div>
    </div>
