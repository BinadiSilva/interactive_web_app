...
<body>
  ...
  <section class="container py-5">
    <div class="row align-items-center">
      <div class="col-md-6">
        <h1 class="display-5 fw-bold mb-3">Welcome to Add&Bake RecipeBook</h1>
        <p class="lead mb-4">
          Discover delicious recipes, share your own dishes, and enjoy cooking with a simple and interactive recipe platform.
        </p>
        <a href="about.html" class="btn btn-dark me-2">Learn More</a>
        <a href="login.html" class="btn btn-outline-dark">Get Started</a>
      </div>
